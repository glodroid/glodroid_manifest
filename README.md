...
GloDroid [wiki](https://github.com/GloDroid/glodroid_manifest/wiki). You could find GloDroid community discord chat [here](https://discord.gg/2z5VUv6).
...
```bash
sudo apt-get install -y python3-pip pkg-config python3-dev
